...
|[Section 1194.22 Web-based Internet information and applications](#section-119422-web-based-internet-information-and-applications)|Supports with exceptions|We strive to comply with [W3C's Web Content Accessibility Guidelines (WCAG) 2.0](https://www.w3.org/TR/WCAG20/) (to level AA).<br>We take accessibility very seriously, and are constantly trying to improve. For instance we developed [pa11y](http://pa11y.org/) - a tool that allows automated accessibility testing. We are using this to monitor our accessibility compliance.|
...
|(l) When pages utilize scripting languages to display content, or to create interface elements, the information provided by the script shall be identified with functional text that can be read by Assistive Technology.|Supports with exceptions|Navigation which uses scripting is accessible to assistive technologies and the keyboard.<br>Some share funationality and recommendations services are only available when utilizing scripting.<br>We are moving towards supporting fully with rollout of a redesign.|
