# <a name="document-top"></a>SpringerOpen Voluntary Product Accessibility Template (VPAT)
...
| [Section 1194.22 Web-based Internet information and applications](#section-119422-web-based-internet-information-and-applications) | Supports with exceptions | The standards that we aim to comply with are the W3C's Web Content Accessibility Guidelines (WCAG) 1.0 (to level II), plus the WCAG Samurai Errata. We include sections from WCAG 2.0, where such guidelines provide more clarity - for instance where WCAG 2.0 specifies appropriate contrast ratios suitable for text, those are the ratios we aim for.<br>We take accessibility very seriously, and are constantly trying to improve.<br>For instance we’ve recently developed pa11y - a tool that allows automated accessibility testing. We are using this with our latest architecture to monitor our accessibility compliance. |
...
| (n) When electronic forms are designed to be completed on-line, the form shall allow people using Assistive Technology to access the information, field elements, and functionality required for completion and submission of the form, including all directions and cues. | Supports | All form fields are labelled and grouped logically, and make use of the “for” attribute to associate labels with their corresponding form element. |
